...
Source1  : https://www.x.org/releases/individual/lib/libXpresent-1.0.0.tar.gz.sig
...
cd %{_builddir}/libXpresent-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593109819
...
cp %{_builddir}/libXpresent-1.0.0/COPYING %{buildroot}/usr/share/package-licenses/libXpresent/ce154c6a0d76d90cd20ef010636eb8e98a4f9fe5
%make_install
